...
import { FormItemData, FormOptionList } from "@/types/item";
import {
  BentukObat,
  DosisObat,
  EfekSamping,
...
const createItem = async (formData: FormItemData): Promise<any> => {
  try {
    var response = await axiosServer.post("/api/master/item/create", formData);
...
export { getOptionData, createItem };
